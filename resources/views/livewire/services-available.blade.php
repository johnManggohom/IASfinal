                ...
                <div class="flex w-full">
                    ...
                    <div class="flex  justify-end w-1/2">
                        <div class="w-full"> <div class="flex justify-end  space-x-4">
                            ...
                            <div  class="w-10 flex items-center justify-center h-10 rounded-full  bg-green-700 hover:bg-green-500 rounded-md text-white"> <a  href="{{ route('admin.services.create') }}"><i class="fas fa-plus text-lg"></i></a></div>
