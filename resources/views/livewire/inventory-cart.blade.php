{{-- <div>
            ...
            <div class="table w-full p-2">
                ...
                <div class="flex w-full">
                    ...
                    <div class="flex w-1/2  items-center">
                        ...
                        <input type="search" wire:model.debounce.300ms="search" class="form-control  h-7 text-xs relative flex-auto w-full px-3 py-1.5 font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Search Name, Service, Price" aria-label="Search" aria-describedby="button-addon2">
                    ...
                    <div class="flex  justify-end w-1/2">
                        <div class="w-full"> <div class="flex justify-end  space-x-4">
                            ...
                            <div  class="w-10 flex items-center justify-center h-10 rounded-full  bg-green-700 hover:bg-green-500 rounded-md text-white"> <a  href="{{ route('admin.inventory.create') }}"><i class="fas fa-plus"></i></a></div>
   ...
   @foreach ( $inventories as  $index=> $inventory)
                                 <tr class="bg-white text-center border-b text-xs text-gray-600">
                                <td class="p-2 ">
                                  @if ($editedInventoryIndex !== $index)
                                  {{ $inventory['name'] }} 
                                  @else
                                 ...
                                 <td class="p-2 "> 
                                  ...
                                  <input type="number"  class="
                                           ...
                                           h-7
                                            ...
                                            m-0
                                            focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none
                                        " wire:model.defer="inventories.{{ $index }}.quantity">
