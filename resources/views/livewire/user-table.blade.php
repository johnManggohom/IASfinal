          ...
          {{-- <div class="mt-1">
                    ...
                    <table class="w-full border-separate border-spacing-y-3 ">
                       ...
                       @foreach ($employees as  $employee)
                                ...
                                <td class="p-3">{{  $employee->roles->first()->name}}</td>
                                ...
                                <td class="flex justify-center">
                                    <a href="{{ route('admin.user.show', $employee->id) }}" class="bg-blue-500 p-3 text-white hover:shadow-lg text-xs font-thin mr-2"> Edit Roles</a>
